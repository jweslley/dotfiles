...
[core]
as_active_plugins = core;move;resize;place;decoration;animation;ccp;commands;video;session;svg;mousepoll;neg;imgjpeg;gnomecompat;vpswitch;resizeinfo;workarounds;extrawm;png;text;wobbly;regex;shelf;annotate;dbus;shift;fade;cube;scale;rotate;scaleaddon;expo;3d;ezoom;staticswitcher;
...
s0_skydome = true
s0_skydome_image = /media/Data/images/skydome/lightning.png
...
as_clear_button = <Alt><Super>Button2
