...
# toolbox
pacman --noconfirm -S rxvt-unicode openssh git bash-completion ttf-ubuntu-font-family net-tools ctags xsel unrar unzip lesspipe ripgrep youtube-dl dosfstools colordiff sudo tmux htop vim gdb cgdb fzf jq direnv
